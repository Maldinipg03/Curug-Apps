...
<body id="index">
    {{-- navbar --}}
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color: #1C6758;">
        <div class="container">
            <a class="navbar-brand" href="#">Curug Cipendok</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/transaksi/buy">Buy Ticket</a>
                    </li>
    ...
    <section id="home" class="jumbotron text-center">
        <div class="header">
            <h1 class="head">WISATA AIR TERJUN</h1>
            <h1 class="head">CURUG CIPENDOK</h1>
            <a href="/transaksi/buy" class="buy">GET TICKET
                <div class="icon-1">
    ...
    {{-- about --}}
    <section id="about" class="about" data-aos="fade-up"data-aos-anchor-placement="bottom-bottom">
        <div class="about1">
            <h3 class="judul text-center">Tentang Curug Cipendok</h3>
            <p class="fs-6 fs-sm-6 px-md-5 info">Curug Cipendok merupakan air terjun dengan ketinggian 92 meter yang
                terletak di lereng Gunung Slamet. Curug Cipendok mempunyai daya tarik tersendiri, sebab lingkungan masih
                benar-benar alami. Kesunyian juga masih sangat terasa. Hawa pada sekitarnya sejuk dan sepanjang jalan
                menuju ke sana ada area perkebunan.
            </p>
        </div>
    </section>
    {{-- end about --}}
    ...
    {{-- caresol atau slider --}}
    <div class="galeri" data-aos="fade-up"data-aos-anchor-placement="bottom-bottom">
        <h3 class="judul text-center">Galeri Curug Cipendok</h3>
        <div class="midlaner d-flex justify-content-center">
            <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    @foreach ($slide as $key => $slide)
                        <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                            <img class="caresoul" src="{{ $slide->image }}" class="d-block w-100" alt="...">
                        </div>
                    @endforeach
    ...
    <footer class="page-footer font-small blue">
        <div class="container text-md-left">
            <div class="row d-flex justify-content-between">
                <div class="col-md-4 mt-md-0 mt-3 address mb-5">
                    <h3 class="curug">Curug Cipendok</h3>
                    <p class="isi1">Wisata alam yang menunjukan keindahan air terjun alami dan masih terjaga </p>
                    <div class="mt-md-5 social-media">
                        <a href="#">
                            <img src="img/instagram.png" alt="instagram" class="img-fluid ig">
                        </a>
                        <a href="#">
                            <img src="img/facebook.png" alt="facebook" class="img-fluid ig">
                        </a>
                    </div>
                </div>

                <div class="row col-md-4 nav-footer">
                    ...
                    <div style="width: 100%"><iframe width="100%" height="200" frameborder="0" scrolling="no"
                            ...
                            src="https://maps.google.com/maps?width=100%25&amp;height=200&amp;hl=en&amp;q=curug%20cipendok+(Curug%20Cipendok)&amp;t=&amp;z=17&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><a
                                href="https://www.maps.ie/population/">Calculate population in area</a></iframe>
                    </div>
